...
export default function PopuloOrderForm({ order, onSuccess, onCancel }) {
  ...
  // Produits disponibles pour Populo (en réalité, cela viendrait d'un appel API)
  const availableProducts = [
    { name: "Salade Buddha Bowl", price: 45 },
    { name: "Smoothie Detox", price: 25 },
    { name: "Wrap Avocat", price: 35 },
    { name: "Jus de Grenade", price: 20 },
    { name: "Plateau Healthy", price: 80 },
    { name: "Salade Quinoa", price: 40 },
    { name: "Smoothie Bowl", price: 30 },
    { name: "Poke Bowl", price: 50 },
    { name: "Acai Bowl", price: 35 },
    { name: "Green Smoothie", price: 22 },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (order) {
        // Modification
        await apiPatch(`/api/admin/populo-orders/${order.id}`, orderData);
      } else {
        // Création
        await apiPost("/api/admin/populo-orders", orderData);
      }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="sarah.benali@email.com"
          />
          {errors.clientEmail && (
